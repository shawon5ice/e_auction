...
class AuctionGalleryItemDetailsScreen extends StatelessWidget {
  ...
  AuctionGalleryItemDetailsScreen({Key? key,
    required this.docId,
    required this.title,
              ...
              builder: (context, snapshot) {
                ...
                switch (snapshot.connectionState) {
                  ...
                  default:
                    ...
                    AuctionGalleryModel auctionGalleryModel = AuctionGalleryModel
                    ...
                    auctionGalleryController.bidStatus(
                        auctionGalleryModel.bidder);
                    if (remainingTime < 0) {
                      remainingTime = 0;
                    }
                    return Column(
                              ...
                              child: Container(
                                ...
                                child: Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Text(
                                        'Bid starts at: ${auctionGalleryModel
                                            .minBidAmount} Tk',
                            ...
                            children: [
                              Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                      'Posted on: ${DateFormat.yMMMd()
                                          .add_jm()
                                          .format((auctionGalleryModel.createdOn
                                          .toDate()))}'),
                                  8.ph,
                                  Text(
                              ...
                              16.ph,
                              remainingTime  > 0 && authorUID !=FirebaseAuth.instance.currentUser!.uid ? ElevatedButton(
                                  onPressed: () {
                                    showDialog(
                                      context: context,
                                      builder: (context) =>
                                            ...
                                            actions: [
                                              TextButton(
                                                ...
                                                style: TextButton.styleFrom(
                                                    foregroundColor: ColorResources
                                                        .ash),
                                  ...
                                  child: auctionGalleryController.neverBid.value
                                      ? const BidButton(
                                    text: 'Edit your bid', icon: Icons.edit,)
                                      : const BidButton(
                                    text: 'Bid Now', icon: Icons.add,)
                              )
                                  : Container(),
                              16.ph,
                              Padding(
